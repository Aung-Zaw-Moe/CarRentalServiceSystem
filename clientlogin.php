...
?>
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
        ...
        <div class="container">
            <div class="jumbotron">
                <h1>Welcome to Car Rental Service </span>
                </h1>
                <br>
                <p>ADMIN LOGIN to continue.</p>
            </div>
        </div>
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-xs-12">
                                    <label for="admin_id"><span class="text-danger" style="margin-right: 5px;">*</span> Username: </label>
                                    <div class="input-group">
                                        <input class="form-control" id="admin_id" type="text" name="admin_id" placeholder="Username" required="" autofocus="">
